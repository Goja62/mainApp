<div x-data="{ isOpen: false }">
    <button x-on:click="isOpen = true; setTimeout(() => document.querySelector('#live-search-field').focus(), 50)"
        style="background: none; border: none; padding: none; margin: none; outline: none; cursor: pointer;"
        href="#" class="text-white mr-2 header-search-icon" title="Search" data-toggle="tooltip"
    ...
    <div class="search-overlay" x-bind:class="isOpen ? 'search-overlay--visible' : ''">
        <div class="search-overlay-top shadow-sm">
            <div class="container container--narrow">
                ...
                <input x-on:keydown="document.querySelector('.circle-loader').classList.add('circle-loader--visible'); if (document.querySelector('#no-results')) {document.querySelector('#no-results').style.display = 'none'}" wire:model.live.debounce.750="searchTerm" autocomplete="off" type="text"
        ...
        <div class="search-overlay-bottom">
            <div class="container container--narrow py-3">
                ...
                <div class="live-search-results live-search-results--visible">
                    ...
                    <p id="no-results" class="alert alert-danger text-center shadow-sm">Sorry, no reults</p>
                    ...
                    <div class="list-group shadow-sm">
                        ...
                        <a href="/post/{{$post->id}}" class="list-group-item list-group-item-action">
                            ...
                            <span class="text-muted small">by {{$post->user->username}} on {{$post->created_at->format('d.m.Y')}}</span>
                        </a>`
                        @endforeach
                    </div>
                    @endif
